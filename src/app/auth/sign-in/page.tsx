...
export default function SignIn() {
    ...
    return (
        <div className="flex min-h-full flex-1 flex-col justify-center w-96 px-6 py-12 lg:px-8 m-auto darK:bg-slate-800">
			{/* { isLoading2 || spinnerLoading ? (
				<p>this is suppose to be a spinner</p>
			) : ( */}
				<section className="w-full rounded-lg px-2.5 shadow dark:border md:mt-0 sm:max-w-md dark:border-gray-700">
					<h3 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight">Log In</h3>
					<form className="space-y-6" onSubmit={handleSubmit}>
						<div>
							<label htmlFor="email" className="block text-sm font-medium leading-6 ">Email:</label>
							<input
								className="block w-full rounded-md border-0 py-1.5 mt-2 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
								type="email"
					...
					<p className="hover:text-slate-500 mt-10text-sm">
